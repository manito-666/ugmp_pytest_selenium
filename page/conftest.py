...
def login_fixtrue(driver):
    ...
    driver = webdriver.Chrome(chrome_options=options,executable_path='/usr/local/bin/chromedrive.exe')
...
def driver(request):
    ...
    if platform.system()=='Windows':
        ...
        _driver = webdriver.Chrome(chrome_options=chrome_options,executable_path='/usr/local/bin/chromedrive.exe')
    else:
